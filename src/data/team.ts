...
export const teamMembers: TeamMemberBio[] = [
  ...
  },
  {
    ...
    photo: "/Dr-Lila.jpeg",
    bio: [
      "Dr. Marston received her medical degree from Northeastern Ohio College of Medicine in Rootstown, Ohio. She completed an internal medicine residency at Loyola University Medical Center in Maywood, Illinois. She completed her fellowship in hematology and medical oncology at the University of Illinois at Chicago and completed an additional advanced fellowship in developmental therapeutics at the Northwestern University Feinberg School of Medicine. Dr. Marston is Board-certified in internal medicine, hematology and medical oncology.",
      "Prior to joining the Zangmeister Cancer Center, she worked as a medical oncologist and hematologist at OhioHealth Physician Group in Mansfield, Ohio. Additionally, Dr. Marston has held the position of assistant professor in The Ohio State University Comprehensive Cancer Center – Arthur G. James Cancer Hospital and Richard J. Solove Research Institute in Columbus, Ohio.",
